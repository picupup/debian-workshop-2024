...
**Nutzernummer/port**: Für deinen Nutzer wähle bitte ein Server ([Auch verfugbar in paired\_ports.txt](https://github.com/picupup/debian-workshop-2024/blob/main/doc/paired_ports.txt)):
